...
- (CGFloat)jdftt_requiredHeightToFitContents
{
    ...
    NSAttributedString *attributedText = self.attributedText == nil ? [[NSAttributedString alloc] initWithString:self.text attributes:@{NSFontAttributeName: self.font}] :  self.attributedText;
